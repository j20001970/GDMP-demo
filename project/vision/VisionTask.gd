...
func _ready():
	...
	#TODO
	#CameraServer.camera_feeds_updated.connect(self._update_camera_feeds)
	if OS.get_name() in ["Android", "iOS", "Linux", "macOS", "Windows"]:
...
func _open_camera() -> void:
	...
	if camera_extension:
		...
		#TODO
			...
			#_select_camera()
		#else:
			#CameraServer.is_monitoring_feeds = true
		pass
